...
def spikedetector3(Params, drez, wTEMP, iC, dist, v2, iC2, dist2):
    ...
    tpP = (int(NT / Nthreads), NchanUp)
    maxChannels = cu.RawKernel(code, 'maxChannels', ('-G',))
    maxChannels(tpP, (Nthreads,), (d_Params, d_dout, d_dmax, d_iC, d_iC2, d_dist2, d_kkmax, d_dfilt, d_st, d_counter, d_cF))
